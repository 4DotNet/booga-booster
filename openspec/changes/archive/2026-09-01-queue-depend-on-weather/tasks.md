...
- [x] 8.2 Build and test the solution (`dotnet build BoogaBooster.slnx`, `dotnet test BoogaBooster.slnx`) and run via Aspire to confirm weather updates visibly change queue fill rates end-to-end.
