...
- [x] 8.2 Run under the Aspire AppHost and confirm the panel loads live weather, drifts over time, and both buttons visibly disturb it
- [x] 8.3 Manually verify keyboard operation, reduced-motion behavior, and contrast on the animated backdrop
