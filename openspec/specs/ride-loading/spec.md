# ride-loading Specification

## Purpose

Defines how queued groups board the ride while it is Loading: free capacity in whole empty gondolas, all-or-nothing group boarding, look-ahead backfill, the full condition, and random empty-gondola selection.
