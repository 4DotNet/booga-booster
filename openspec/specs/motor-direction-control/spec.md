# motor-direction-control Specification

## Purpose

Defines the commanded rotation direction for the mill and hub motor groups, how it signs the drive torque, and reversal through rest.
