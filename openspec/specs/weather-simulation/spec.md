# weather-simulation Specification

## Purpose

Defines the autonomous weather world state: defaults, validated readings, bounded drift, mean reversion, deterministic clock and randomness, and update publication.
