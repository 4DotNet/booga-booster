# ride-dashboard-layout Specification

## Purpose

Defines the operator dashboard as the landing page: its three-column layout, status summary, central 3D visualization, and accessibility baseline.
