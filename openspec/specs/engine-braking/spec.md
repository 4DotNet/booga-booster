# engine-braking Specification

## Purpose

Defines the engine brake: its operator toggle, the brake torque that stops the ride, automatic application while stopping, and its telemetry.
