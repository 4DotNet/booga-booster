# ride-state-machine Specification

## Purpose

Defines the ride's lifecycle states, the guarded transitions between them, and how state confines motion and safety constraints.
