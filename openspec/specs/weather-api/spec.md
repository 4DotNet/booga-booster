...
Defines the Weather module's HTTP surface: reading current weather, triggering precipitation and strong wind, and the conditions exposed to other modules.
