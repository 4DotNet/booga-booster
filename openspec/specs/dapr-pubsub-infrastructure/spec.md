# dapr-pubsub-infrastructure Specification

## Purpose

Defines how Dapr pub/sub and the RabbitMQ broker are provisioned through Aspire and how sidecars attach to publishing and subscribing projects.
