...
/// </summary>
public sealed class DigitalTwinHandlerInstrumentationGateTests
{
    ...
    private static List<Type> HandlerTypes()
        => [.. typeof(FourDotnet.BoogaBooster.DigitalTwin.Features.StartRide.StartRideCommandHandler).Assembly
            .GetTypes()
