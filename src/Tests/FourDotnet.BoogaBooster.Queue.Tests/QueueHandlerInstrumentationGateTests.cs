...
/// </summary>
public sealed class QueueHandlerInstrumentationGateTests
{
    ...
    private static List<Type> HandlerTypes()
        => [.. typeof(FourDotnet.BoogaBooster.Queue.Features.GetQueueStatus.GetQueueStatusQueryHandler).Assembly
            .GetTypes()
